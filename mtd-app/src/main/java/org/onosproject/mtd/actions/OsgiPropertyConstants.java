...
public final class OsgiPropertyConstants {
    ...
    static final boolean MATCH_IPV4_DSCP_DEFAULT = true;

    static final String MATCH_IPV6_ADDRESS = "matchIpv6Address";
    static final boolean MATCH_IPV6_ADDRESS_DEFAULT = true;

    static final String MATCH_IPV6_FLOW_LABEL = "matchIpv6FlowLabel";
    static final boolean MATCH_IPV6_FLOW_LABEL_DEFAULT = true;
